...
python3 -m fragma concurrency-c1 \
  --c0-result results/concurrency-c0-20260907-05 \
...
The final [C0 result](../results/concurrency-c0-20260907-05/SUMMARY.md) pins the
...
The [C1 result](../results/concurrency-c1-20260907/SUMMARY.md) passes all 82
checks. Its [machine-readable audit](../results/concurrency-c1-20260907/pilot-audit.json)
...
[negative-control summary](../results/concurrency-c1-stale-control-20260907/SUMMARY.md)
is a required **FAIL**:
...
[905-test project run](../results/tests-rv32-concurrency-20260907.log) passes with
