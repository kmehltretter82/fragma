...
PREVIOUS_SHA = "cc1b74dbd9be6624de09589b9f02eaca550c5877bd69908ed98d1cea793733d7"
...
def snapshot(d, rt, c, h, old, specifications, sources, fixture_pin):
    ...
    previous, artifacts = d.retained_tree(c, h, BASE / "extra-context-run-3", PREVIOUS_SHA)
...
def main():
    ...
    rt = d.load(BASE / "check_candidate_runtime_v5.py", d.PINS[BASE / "check_candidate_runtime_v5.py"])
    c = rt.load_builder(d.PINS[BASE / "build_candidate_v5.py"])
    h = c.load_helper()
