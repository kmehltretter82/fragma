...
RECORDER = BASE / "diagnose_candidate_context.py"
RECORDER_SHA = "c51f15b50e9c6c7f404b91bdd80eaf312013080c6382ed61efa904113e7d06b6"
CLASSIFIER_SHA = "37419daca86065f5586eca22ee917ae7fea430976092331e8528b92501427050"
PREVIOUS_SHA = "6d71f4cfe091264d70d1bc49ad95b611eb3aaaeb1024c3efd7b351ec9d300e60"
...
def snapshot(d, rt, c, h, old, specifications, sources, fixture_pin):
    ...
    previous, artifacts = d.retained_tree(c, h, BASE / "context-run-1", PREVIOUS_SHA)
    d.require(previous["input_drift"] is False and not previous["cancelled"]
              and previous["status"] == "private-context-observations-complete-not-support",
              "Previous private context prerequisite changed")
    ...
    return {"context_prerequisites": original, "previous_private_artifacts": artifacts,
...
def main():
    ...
    rt = d.load(BASE / "check_candidate_runtime_v2.py", d.PINS[BASE / "check_candidate_runtime_v2.py"])
    c = rt.load_builder(d.PINS[BASE / "build_candidate_v2.py"])
    h = c.load_helper()
