#!/usr/bin/env python3
"""Repeat all 55 unchanged pairs with the reviewed V2 local witness decoder.

The executed V1 recorder, classifiers and receipt remain unchanged. The full
V1 retained artifact tree is checked before and after this fresh execution.
...
BUILD = BASE / "candidate-build-2"
RUNTIME = BASE / "candidate-runtime-2"
...
PINS = {
    ...
    BASE / "context-run-1/receipt.json": "6d71f4cfe091264d70d1bc49ad95b611eb3aaaeb1024c3efd7b351ec9d300e60",
    ...
    BASE / "check_candidate_runtime_v2.py": "a094b0ee274ac66e5e4e62e823e5543803ba92c3340c3595292431536556af06",
    BASE / "build_candidate_v2.py": "e9210a6a2d08e6c2d1783a8fc3d9d45a98145eda1b46168bc1a3486c5b8b2869",
    BUILD / "receipt.json": "8153590cfd0613d22663f743b2fd382ad2663cb49ff3546803eae33d401bdb10",
    RUNTIME / "receipt.json": "8773296cb124904b6c0944e22576392ffbd78a799883601d934ace2399209082",
...
BINARY_SHA = "d8435871161925515ef043ee9e88138b40b64becc9e453a90525658076d770ed"
...
def snapshot(rt, c, h, old, classifiers_pin, sources):
    ...
    args = types.SimpleNamespace(receipt_sha256=PINS[BUILD / "receipt.json"], binary_sha256=BINARY_SHA,
                                 build_recorder_sha256=PINS[BASE / "build_candidate_v2.py"])
    ...
    previous, previous_tree = retained_tree(c, h, BASE / "context-run-1", PINS[BASE / "context-run-1/receipt.json"])
...
def main():
    ...
    rt = load(BASE / "check_candidate_runtime_v2.py", PINS[BASE / "check_candidate_runtime_v2.py"])
    c = rt.load_builder(PINS[BASE / "build_candidate_v2.py"])
    h = c.load_helper()
