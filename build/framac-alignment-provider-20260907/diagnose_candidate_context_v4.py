#!/usr/bin/env python3
"""Repeat all 55 unchanged pairs against the fresh VLA/typed-alignment candidate.

The executed V1/V2/V3 recorders, classifiers and receipts remain unchanged. The
V3 retained artifact tree is checked before and after this fresh execution.
...
BUILD = BASE / "candidate-build-4"
RUNTIME = BASE / "candidate-runtime-4"
...
PINS = {
    ...
    BASE / "context-run-3/receipt.json": "2c7d6f9a56cee476948162ea1125528b962589a4e1ace41ff5c8233ab08eabae",
    ...
    BASE / "check_candidate_runtime_v4.py": "c6d6528257083d16a6b14536673b84fa071e91602f8b6b2bfbd8683faffd44cf",
    BASE / "build_candidate_v4.py": "137a711930a309399a220c5315ae298da7f950fdc57bcfb99b69dd577a728084",
    BUILD / "receipt.json": "1e59bd611fbdc513374856049d6d61f23cfb21c09eb5dff5356c6821256b4e9e",
    RUNTIME / "receipt.json": "025f0e9687013859d4c979ae7a615e2240bfd616689527d52af506ff5b2302b6",
...
BINARY_SHA = "03aac0c5cb7eec9e72ec75bef9a8eefe0921a20e1f380d71d52f9a798d6ca748"
...
def snapshot(rt, c, h, old, classifiers_pin, sources):
    ...
    args = types.SimpleNamespace(receipt_sha256=PINS[BUILD / "receipt.json"], binary_sha256=BINARY_SHA,
                                 build_recorder_sha256=PINS[BASE / "build_candidate_v4.py"])
    ...
    previous, previous_tree = retained_tree(c, h, BASE / "context-run-3", PINS[BASE / "context-run-3/receipt.json"])
...
def main():
    ...
    rt = load(BASE / "check_candidate_runtime_v4.py", PINS[BASE / "check_candidate_runtime_v4.py"])
    c = rt.load_builder(PINS[BASE / "build_candidate_v4.py"])
    h = c.load_helper()
