...
RECORDER = BASE / "diagnose_candidate_context_v3.py"
RECORDER_SHA = "6f58a09cfb9b78b9ebca5b1a34c014eecdd19b9d67311cb4327da990f78447eb"
CLASSIFIER_SHA = "ca315f499eff71d75a05d1a1100cdb8ae5a51fa8d119870c0f63e7d778b7d8a8"
PREVIOUS_SHA = "75a060bf654d531d0714b3627a6a88a9e70e0d327e7c0d66adb27d1e6c3b51bb"
...
def snapshot(d, rt, c, h, old, specifications, sources, fixture_pin):
    ...
    previous, artifacts = d.retained_tree(c, h, BASE / "extra-context-run-1", PREVIOUS_SHA)
...
def main():
    ...
    rt = d.load(BASE / "check_candidate_runtime_v3.py", d.PINS[BASE / "check_candidate_runtime_v3.py"])
    c = rt.load_builder(d.PINS[BASE / "build_candidate_v3.py"])
    h = c.load_helper()
