#!/usr/bin/env python3
"""Repeat all 55 unchanged pairs against the fresh declaration candidate.

The executed V1/V2 recorders, classifiers and receipts remain unchanged. The
V2 retained artifact tree is checked before and after this fresh execution.
...
BUILD = BASE / "candidate-build-3"
RUNTIME = BASE / "candidate-runtime-3"
...
PINS = {
    ...
    BASE / "context-run-2/receipt.json": "9ee43d6597e0841315f4b070190f7cfba815548e02cd997993699d6feaa30630",
    ...
    BASE / "check_candidate_runtime_v3.py": "5a4f760ac76c858a16e662ac4bac8b455c621c60642df7fd24160b0fb7bc133b",
    BASE / "build_candidate_v3.py": "e1f9c310040ecf2588da7648de9a490e277926b9116096e39c714bbe53a98668",
    BUILD / "receipt.json": "d54d44216ef6f61902935441887e94025f6dbd328ca72b3d353018f497950832",
    RUNTIME / "receipt.json": "3a3ce8c1dddd2ff6f88cb8876858fbc7d79f23dba3fe9a792387154f8c38aad2",
...
BINARY_SHA = "c514f183fb4eb4f6d225396ce94da37c75c40116d6d472935a4169ac88bc37bd"
...
def snapshot(rt, c, h, old, classifiers_pin, sources):
    ...
    args = types.SimpleNamespace(receipt_sha256=PINS[BUILD / "receipt.json"], binary_sha256=BINARY_SHA,
                                 build_recorder_sha256=PINS[BASE / "build_candidate_v3.py"])
    ...
    previous, previous_tree = retained_tree(c, h, BASE / "context-run-2", PINS[BASE / "context-run-2/receipt.json"])
...
def main():
    ...
    rt = load(BASE / "check_candidate_runtime_v3.py", PINS[BASE / "check_candidate_runtime_v3.py"])
    c = rt.load_builder(PINS[BASE / "build_candidate_v3.py"])
    h = c.load_helper()
