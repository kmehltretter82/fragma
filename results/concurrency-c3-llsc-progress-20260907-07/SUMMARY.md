...
| `loongarch64-clang-ipc-refcount-c3` | `llsc_get_with_native_amo_put` | not_promoted | PASS |
| `mips32el-clang-ipc-refcount-c3` | `llsc_only_selected_object` | not_promoted | PASS |

Evidence checks: **609/609 passed**.
