...
Semantic calibrations accepted: **0**
Production kernel properties accepted: **0**

| Case | Role | Condition outcome | Witnesses +/− | States | Gate |
|---|---|---|---:|---:|---|
| `mp_once_once` | weakened_control | unparsed | ?/? | ? | FAIL |
| `mp_release_acquire` | ordered_calibration | unparsed | ?/? | ? | FAIL |
| `sb_once_once` | weakened_control | unparsed | ?/? | ? | FAIL |
| `sb_full_barrier` | ordered_calibration | unparsed | ?/? | ? | FAIL |

Evidence checks: **74/92 passed**.
