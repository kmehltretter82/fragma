...
Overall source-linked gate: **FAIL**

Accepted kernel lifetime properties: **0**
Checked architecture mappings: **7**
...
| `powerpc32-smp-ipc-refcount-c3` | `powerpc` | `smp-multicpu` | ELF32, machine 20 | FAIL |
...
Evidence checks: **736/738 passed**.
