...
Checked architecture mappings: **11**
...
| `mips32el-clang-ipc-refcount-c3` | `mips` | `smp-multicpu` | ELF32, machine 8 | PASS |
...
Evidence checks: **1036/1036 passed**.
...
LKMM RMW axiom, and all 11 configured SMP profiles
listed above.
