 ...
 * The additional byte annotations are checked intermediate facts, not new
 * preconditions. The 48-bit proof group is analyzed separately from the 24-bit
 * group; all original helper and witness C bodies and contracts are retained.
 */
...
{
	/*@ assert decompose_48_0: (integer)val == (val & 255) + 256 * (integer)(val >> 8); */
	/*@ assert decompose_48_1: (val >> 8) == ((val >> 8) & 255) + 256 * (integer)(val >> 16); */
	/*@ assert decompose_48_2: (val >> 16) == ((val >> 16) & 255) + 256 * (integer)(val >> 24); */
	/*@ assert decompose_48_3: (val >> 24) == ((val >> 24) & 255) + 256 * (integer)(val >> 32); */
	/*@ assert decompose_48_4: (val >> 32) == ((val >> 32) & 255) + 256 * (integer)(val >> 40); */
	/*@ assert decompose_48_5: (val >> 40) == ((val >> 40) & 255) + 256 * (integer)(val >> 48); */
	*p++ = (val >> 40) & 0xff;
	*p++ = (val >> 32) & 0xff;
	*p++ = (val >> 24) & 0xff;
	*p++ = (val >> 16) & 0xff;
...
{
	/*@ assert decode_decompose_48_0: (p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) == ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) & 255) + 256 * ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 8); */
	/*@ assert decode_decompose_48_1: ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 8) == (((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 8) & 255) + 256 * ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 16); */
	/*@ assert decode_decompose_48_2: ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 16) == (((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 16) & 255) + 256 * ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 24); */
	/*@ assert decode_decompose_48_3: ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 24) == (((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 24) & 255) + 256 * ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 32); */
	/*@ assert decode_decompose_48_4: ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 32) == (((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 32) & 255) + 256 * ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 40); */
	/*@ assert extracted_48_byte_0: ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 40) == p[0]; */
	/*@ assert extracted_48_byte_1: (((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 32) & 255) == p[1]; */
	/*@ assert extracted_48_byte_2: (((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 24) & 255) == p[2]; */
	/*@ assert extracted_48_byte_3: (((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 16) & 255) == p[3]; */
	/*@ assert extracted_48_byte_4: (((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) >> 8) & 255) == p[4]; */
	/*@ assert extracted_48_byte_5: ((p[0] << 40 | p[1] << 32 | p[2] << 24 | p[3] << 16 | p[4] << 8 | p[5]) & 255) == p[5]; */
...
{
	u8 bytes[6];
	/*@ assert roundtrip_decompose_48_0: (integer)val == ((integer)val % 256) + 256 * ((integer)val / 256); */
	/*@ assert roundtrip_decompose_48_1: ((integer)val / 256) == (((integer)val / 256) % 256) + 256 * ((integer)val / 65536); */
	/*@ assert roundtrip_decompose_48_2: ((integer)val / 65536) == (((integer)val / 65536) % 256) + 256 * ((integer)val / 16777216); */
	/*@ assert roundtrip_decompose_48_3: ((integer)val / 16777216) == (((integer)val / 16777216) % 256) + 256 * ((integer)val / 4294967296); */
	/*@ assert roundtrip_decompose_48_4: ((integer)val / 4294967296) == (((integer)val / 4294967296) % 256) + 256 * ((integer)val / 1099511627776); */
	/*@ assert roundtrip_decompose_48_5: ((integer)val / 1099511627776) == (((integer)val / 1099511627776) % 256) + 256 * ((integer)val / 281474976710656); */
