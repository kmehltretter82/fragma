...
| --- | --- | --- |
| `0001-module-reject-invalid-relocation-section-target-indices.patch` | Ready for the submitter's final review | Frama-C lead plus same-input ARM32 and PA-RISC QEMU A/B; full patched ARM64, RISC-V and LoongArch builds |
